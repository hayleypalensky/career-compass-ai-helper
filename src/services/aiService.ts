...
export const aiService = {
  ...
  async generateBulletPoints(currentBullet: string, jobTitle: string, jobDescription: string, relevantSkills: string[], suggestionType?: 'profile-based' | 'job-focused'): Promise<string[]> {
    try {
